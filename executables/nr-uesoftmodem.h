...
#define  CONFIG_HLP_ACTOR_AFFINITY         "Comma-separated cores for DL then UL actors (and SYNC if one spare). Must have at least num-dl-actors + num-ul-actors entries; omit for no affinity\n"
